...
| 역할군 | 공통 규칙 |
| --- | --- |
| 수호군 | 공격자의 사거리 안에 있으면 다른 역할군보다 우선 공격 대상이 된다. |
| 돌격군 | 사거리 1의 근접 기본공격을 사용한다. |
| 사격군 | 원거리 기본공격 또는 특수 탄환을 사용한다. |
| 술사 | 기본공격 대신 메테오나 연쇄 번개 같은 공격 주문을 사용한다. |
| 지원군 | 기본공격을 사용할 수 없고 회복·강화·약화·오라 행동만 수행한다. 유효한 지원 행동이 없으면 대기한다. |

### 9.3 유닛 명단과 초기 능력치

| 등급 | 이름 | 역할군 | 체력 | 위력 | 사거리 | 주기 | 고유 능력 |
| --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| 일반 | 방패병 | 수호군 | 180 | 공격 8 | 1 | 1.4초 | 수호군 우선 공격 대상 |
| 일반 | 검사 | 돌격군 | 120 | 공격 18 | 1 | 1.0초 | 기본 근접공격 |
| 일반 | 궁수 | 사격군 | 85 | 공격 14 | 2 | 1.2초 | 기본 원거리 공격 |
| 일반 | 치유사 | 지원군 | 90 | 회복 11 | 1 | 1.4초 | 범위 내 부상 아군 전체 회복 |
| 희귀 | 폭탄병 | 돌격군 | 90 | 공격 10 | 1 | 1.4초 | 사망 시 주변 모든 유닛에게 40 피해, 아군 포함 |
| 희귀 | 닌자 | 돌격군 | 105 | 공격 6/26 | 1 | 0.7초 | 주변 1칸에 아군이 없을 때 공격력 26 |
| 희귀 | 철갑 수호자 | 수호군 | 270 | 공격 7 | 1 | 1.6초 | 받는 피해 15% 감소 |
| 희귀 | 전투 사제 | 지원군 | 120 | 회복 22 | 2 | 1.5초 | 체력 비율이 가장 낮은 아군 하나 회복 |
| 영웅 | 스나이퍼 | 사격군 | 90 | 공격 30 | 5 | 2.0초 | 8방향 직선 관통 공격 |
| 영웅 | 주술사 | 지원군 | 120 | 지원 | 2 | 상시 | 범위 내 적 공격력 30% 감소, 중첩 없음 |
| 영웅 | 치어리더 | 지원군 | 145 | 지원 | 1 | 상시 | 주변 공격형 아군 공격속도 30% 증가, 중첩 없음 |
| 영웅 | 마법사 | 술사 | 105 | 공격 38 | 3 | 3.0초 | 대상 주변 1칸 메테오 범위 피해 |
| 전설 | 고대 수호자 | 수호군 | 420 | 공격 9 | 1 | 1.8초 | 주변 비수호군 아군 피해 30% 대신 받기 |
| 전설 | 불사조 기사 | 돌격군 | 190 | 공격 24 | 1 | 0.9초 | 생애 최초 치명 피해 시 체력 50% 부활과 주변 적 40 피해 |
| 전설 | 폭풍 현자 | 술사 | 130 | 공격 34 | 3 | 2.4초 | 최대 3명에게 100%·70%·45% 연쇄 피해 |
| 전설 | 생명의 성녀 | 지원군 | 160 | 회복 24 | 3 | 2.0초 | 광역 회복, 전투당 한 번 아군 치명 피해를 막고 30 회복 |
